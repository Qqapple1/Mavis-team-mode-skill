...
3. **Cleaner release notes** — you can see "bash release 1.3.12" and
   "Windows release 1.3.12" are the same content, different installer
...
```
mavis-team-mode-skill-1.3.12-core.zip        (38 files, ~120KB)
mavis-team-mode-skill-1.3.12-bash.tar.gz     (41 files, ~127KB)
mavis-team-mode-skill-1.3.12-windows.zip     (41 files, ~130KB)
mavis-team-mode-skill-1.3.12-source.tar.gz   (48 files, ~150KB)
mavis-team-mode-skill-1.3.12-source.zip      (48 files, ~155KB)
