...
3. **Cleaner release notes** — you can see "bash release 1.3.16" and
   "Windows release 1.3.16" are the same content, different installer
...
```
mavis-team-mode-skill-1.3.16-core.zip        (38 files, ~120KB)
mavis-team-mode-skill-1.3.16-bash.tar.gz     (41 files, ~127KB)
mavis-team-mode-skill-1.3.16-windows.zip     (41 files, ~130KB)
mavis-team-mode-skill-1.3.16-source.tar.gz   (48 files, ~150KB)
mavis-team-mode-skill-1.3.16-source.zip      (48 files, ~155KB)
