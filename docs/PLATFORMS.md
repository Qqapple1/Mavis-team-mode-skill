...
3. **Cleaner release notes** — you can see "bash release 1.3.13" and
   "Windows release 1.3.13" are the same content, different installer
...
```
mavis-team-mode-skill-1.3.13-core.zip        (38 files, ~120KB)
mavis-team-mode-skill-1.3.13-bash.tar.gz     (41 files, ~127KB)
mavis-team-mode-skill-1.3.13-windows.zip     (41 files, ~130KB)
mavis-team-mode-skill-1.3.13-source.tar.gz   (48 files, ~150KB)
mavis-team-mode-skill-1.3.13-source.zip      (48 files, ~155KB)
