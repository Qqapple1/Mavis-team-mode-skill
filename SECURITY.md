...
https://github.com/Qqapple1/TeamForge/security/advisories/new
...
1. **Review the skill before installing**:
   ```bash
   git clone https://github.com/Qqapple1/TeamForge
   less teamforge/SKILL.md
   less teamforge/agents/leader.md
   ```
...
https://github.com/Qqapple1/TeamForge/issues
